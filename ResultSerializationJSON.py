...
input_file = "Constraint_Validation_Constraint_Violated.txt"
#input_file = "Constraint_Validation_Successful.txt"
output_file = "Constraint_Validation_Constraint_Violated.json"
